...
export function RepositoryWorkspacePage() {
  ...
  function selectView(view: RepositoryWorkspaceView) { const params = new URLSearchParams(searchParams); if (view === 'summary') params.delete('view'); else params.set('view', view); setSearchParams(params); }
