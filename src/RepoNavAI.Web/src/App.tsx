...
import { RepositoryWorkspacePage } from './repositories/RepositoryWorkspacePage';
export function App(){return <Routes><Route path="/login" element={<LoginPage/>}/><Route path="/register" element={<RegisterPage/>}/><Route path="/auth/callback" element={<ExternalAuthCallbackPage/>}/><Route element={<ProtectedRoute/>}><Route element={<DashboardPage/>}><Route index element={<WorkspaceOverviewPage/>}/><Route path="repositories" element={<Navigate to="/#repositories" replace/>}/><Route path="repositories/:repositoryId" element={<RepositoryWorkspacePage/>}/><Route path="organization/members" element={<OrganizationMembersPage/>}/><Route element={<OrganizationSettingsRoute/>}><Route path="organization/settings" element={<OrganizationSettingsPage/>}/></Route><Route path="settings/profile" element={<ProfileSettingsPage/>}/></Route><Route path="/invitations/:token" element={<AcceptInvitationPage/>}/></Route><Route path="*" element={<Navigate to="/" replace/>}/></Routes>;}
